...
output  :  sayi1=34 ve sayi2=20
    ...
    public static void main(String[] args) {
        ...
        System.out.println("**** swapten sonraki cözümü***");
        int temp = sayi1;
        sayi1 = sayi2;
        sayi2 = temp;
        System.out.println(sayi1 + " " + sayi2);
        */
        System.out.println("sayi1 ve sayi2 önceki hali = " + (sayi1 + " " + sayi2));
        sayi1=sayi1+sayi2;
        sayi2=sayi1-sayi2;
        sayi1=sayi1-sayi2;
        System.out.println("sayi1 ve sayi2 yeni hali = " + (sayi1 + "  " +sayi2));
