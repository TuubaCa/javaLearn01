...
public class C11_putIfAbsent {
    public static void main(String[] args) {
        ...
        System.out.println("hm.putIfAbsent(\"olmayanKey\",\"hic mi yok\") = " + hm.putIfAbsent("olmayanKey", "hic mi yok"));//null
        System.out.println("hm putIfAbsent() sonrasi = " + hm);//{Apple=450 Euro, Saturn=200 Euro, Teknosa=333 Euro, Media Markt=444 Euro, Amazon=296 Euro, olmayanKey=hic mi yok, Vatan=111 Euro}
    }
}
