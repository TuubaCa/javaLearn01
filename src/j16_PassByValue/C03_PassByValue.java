...
public class C03_PassByValue {
    ...
    private static void listUpdate1(List<Integer> list) {
        for (Integer avuc:list){
            avuc+=33;  // bu ekleme sadece avuca ekler //heap memoriye karısamıyoruz elemanlar stackte duruyor ve stakte elemanları arttırabiliyoruz.
           // System.out.print(avuc+" ");//57 53 120
        }
