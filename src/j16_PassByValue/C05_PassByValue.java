...
public class C05_PassByValue {
    public static void main(String[] args) {
       ...
       2 .değişklik  yapılan variable'lar atama tanımlanır.
         */
        double etiketFiyati=100;//Primitive main scope initial(ilk deger atama yapilmis) variable
        double indirimOrani=0.1;//Primitive main scope initial(ilk deger atama yapilmis) variable
