...
public class C06_IllegalArgumantException {
    // IllegalargumentException -> kullanılmasını istenmeyen değerlerde program hata vermesi isteniyorsa bu excp fırlatılıer
 ...
 */
        ...
        try {
            if (yas<18){
                ...
                hata();//throw exc meth call edildi//2.yol
