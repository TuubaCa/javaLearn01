...
// NullPointerException -> null ataması yapılan bir String variable length() meth call edildiğinde oluşan RTE. null dutluktur işleme filan giremez
        String str1="";
        ...
        System.out.println("********");
        try {
            System.out.println("str2.length() = " + str1.length());//0->RTE exc firlatmaz alt satira iner catch blok calısmaz
            System.out.println("try block sorunsuz calıst.");
        }catch (NullPointerException e){
            System.out.println("try block exc firlatti ");
            System.out.println("bu mesaji okuyorsan catch block calıstı ");
