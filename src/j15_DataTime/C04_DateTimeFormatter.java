...
public class C04_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        System.out.println("bugun = " + bugun);//2024-02-26T20:43:56.838398900
        System.out.println("dtf1.format(bugun) = " + dtf1.format(bugun));//26 * Şub * 24
        System.out.println("dtf2.format(bugun) = " + dtf2.format(bugun));//20 $ 43 $ 56
        System.out.println("dtf3.format(bugun) = " + dtf3.format(bugun));//08 : 43 : 56
