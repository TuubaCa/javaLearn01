 ...
 */
        ...
        System.out.println("yeniTc = " + yeniTc); //98765432
        System.out.println("tc = " + tc);//98765432
     ...
     */
        String strA = "$13.99";
        String strB = "$17.55";
        double yeniA =Double.parseDouble(strA.substring(1));//iki şekilde de çözebiliriz alttakiyle
        double yeniB =Double.parseDouble(strB.replace("$",""));
        System.out.println("strA+strB= " + (yeniA+yeniB));//31.54

        //string de valueOf tercih edip double ve int lerde parseOf kullanırız.
