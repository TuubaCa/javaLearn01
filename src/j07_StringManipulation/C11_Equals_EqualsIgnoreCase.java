...
public class C11_Equals_EqualsIgnoreCase {
    ...
    public static void main(String[] args) {
        ...
        String str3 = "Sema";//string pool (aynı referans degere tanımlama yapıyor->yani adres aynı oluyor)
        String str4 = "Sema";//string pool (aynı referans degere tanımlama yapıyor->yani adres aynı oluyor)
        ...
        System.out.println("str4.equals(str3) = " + str4.equals(str3));//true
        System.out.println(str3==str5);//false
        System.out.println("str3.equals(str5) = " + str3.equals(str5));//true
        System.out.println(str6==str5);//false
        System.out.println("str6.equals(str5) = " + str6.equals(str5));//true
