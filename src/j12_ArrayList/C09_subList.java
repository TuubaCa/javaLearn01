...
public class C09_subList {
    public static void main(String[] args) {
        ...
        System.out.println("sublist öncesi ulkeList = " + ulkeList);//[Alamanya, Isvec, Danimarka, Belcika, Hollanda, Finlandiya]
        System.out.println("ulkeList.subList(1,4) = " + ulkeList.subList(1, 4));//[Isvec, Danimarka, Belcika]
        System.out.println("sublist sonrası ulkeList = " + ulkeList);//[Alamanya, Isvec, Danimarka, Belcika, Hollanda, Finlandiya]
